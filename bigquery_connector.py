...
class bigquery_connector:
    ...
    def select_messages(self, userid, start = 'NULL', end = 'NULL', order='desc'):
        ...
        if userid is None:
            ...
            user_id_condition = f'AND user_id = {userid}'
    ...
    def total_message_count(self):
        ...
        table_ref = self.client.dataset(self.project).table(f'{self.environment}_raw.raw_messages')
        table = self.client.get_table(table_ref)
        row_count = table.num_rows

        return row_count
    
    def message_count(self, userid, start='NULL', end='NULL'):
